function calcShipping(sum, min, shipping) {
    ...
    if (productsSum == 0 || productsSum >= freeShippingMinSum)                     //если productsSum равно 0 или если productsSum больше или равен freeShippingMinSum                  
       {shippingSum = 0;                                                           //shippingSum присвоить значение 0 
        }  
...
function calcInvoice({sum, discountMinSum, discountPart, shippingFreeMinSum, shippingPrice}) {
    ...
    let totalSum;                                                         // создайте переменную totalSu
